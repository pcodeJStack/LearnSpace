          ...
          <div className="space-y-5">
            ...
            <div className="space-y-5">
              <h2 className="max-w-md text-4xl font-extrabold tracking-tight text-slate-900 sm:text-5xl">
                <span className="block leading-[1.15]">Thông tin</span>
              ...
              <p className="max-w-sm pt-1 text-sm leading-7 text-slate-500">
                Cập nhật ảnh đại diện và thông tin liên hệ — hồ sơ hiển thị với
          ...
          >
            ...
            <div className="relative flex items-center gap-4">
              ...
              <div className="min-w-0">
                ...
                <p className="truncate text-sm text-slate-500">{emailValue}</p>
              </div>
            </div>
            ...
            >
              <div>
                ...
                <p className="mt-1 text-sm text-slate-500">
                  Email không thể chỉnh sửa. Cập nhật họ tên và địa chỉ khi cần.
                </p>
              </div>
                    ...
                    <FormItem>
                      ...
                      <FormControl>
                        <div className="relative">
                          ...
                          <Textarea
                            {...field}
                            className="min-h-[120px] resize-none rounded-xl border-[#ebe7ff] bg-white pl-10 focus-visible:border-[#6c5ce7] focus-visible:ring-[rgba(108,92,231,0.2)]"
