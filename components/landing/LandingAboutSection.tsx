      ...
      <div className="mx-auto grid max-w-6xl gap-14 lg:grid-cols-[1fr_1fr] lg:gap-20">
        <div>
          ...
          <h2 className="mt-3 text-[1.85rem] font-extrabold leading-[1.15] tracking-[-0.03em] text-slate-900 sm:text-[2.35rem]">
            Course Learning
            <span className="block text-teal-600">là gì?</span>
          </h2>
          ...
          <Link
            ...
            className="mt-8 inline-flex h-12 items-center gap-2 rounded-full bg-orange-500 px-6 text-sm font-bold text-white transition hover:bg-orange-600"
          >
            Vào hệ thống
        ...
        <div className="border-t border-slate-200">
          {aboutPoints.map((point) => {
            ...
            return (
              <div
                key={point.title}
                className="grid grid-cols-[auto_1fr] gap-4 border-b border-slate-200 py-7"
              >
                <Icon
